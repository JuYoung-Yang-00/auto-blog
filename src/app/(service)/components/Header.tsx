...
const Header: React.FC = () => {
    ...
    return (
      <div className='fixed top-0 left-0 right-0 z-50 transition-transform duration-300 backdrop-blur-sm'
      ...
      >
        <div className="flex flex-row w-full gap-10 h-[35px] lg:h-[45px] items-center justify-between px-2 lg:px-8 max-w-[1480px] mx-auto">
          <div className='flex flex-row gap-8 items-center'>
            ...
            <Link href='/'>
                <span className='font-extralight hover:font-light lg:text-md text-sm hidden lg:flex ml-1'>Dashboard</span>
            </Link>
            <Link href='/profile'>
                <span className='font-extralight hover:font-light lg:text-md text-sm hidden lg:flex'>Profile</span>
            </Link>
          </div>
